...
const sampleProjects = [
  ...
  {
    title: "Qatar Fitness Tracker",
    titleAr: "تطبيق قطر للياقة البدنية",
    category: "Health & Fitness App",
    categoryAr: "تطبيق الصحة واللياقة",
    description: "Personalized workout and nutrition tracking",
    descriptionAr: "تتبع التمارين والتغذية الشخصية",
    type: "mobile",
    client: "Qatar Fitness Club",
    clientAr: "نادي قطر للياقة البدنية",
    challenge: "Members needed a way to track workouts, access personalized nutrition plans, and stay motivated between gym visits.",
    challengeAr: "كان الأعضاء بحاجة إلى طريقة لتتبع التمارين والوصول إلى خطط التغذية الشخصية والبقاء متحفزين بين زيارات الصالة الرياضية.",
    solution: "Created a comprehensive fitness app with workout tracking, custom meal plans, progress photos, social features, and integration with wearable devices.",
    solutionAr: "أنشأنا تطبيق لياقة بدنية شامل مع تتبع التمارين وخطط وجبات مخصصة وصور التقدم والميزات الاجتماعية والتكامل مع الأجهزة القابلة للارتداء.",
    results: "70% increase in member engagement, 1,500+ active users, Featured in Qatar health and wellness category",
    resultsAr: "زيادة بنسبة 70٪ في تفاعل الأعضاء، أكثر من 1500 مستخدم نشط، مميز في فئة الصحة والعافية في قطر",
    technologies: ["React Native", "Node.js", "MongoDB", "Apple HealthKit", "Google Fit"],
    imageUrl: "/attached_assets/generated_images/Mobile_app_mockup_clean_d2c9db56.png"
  },
  {
    title: "Qatar Real Estate Portal",
    titleAr: "بوابة العقارات قطر",
    category: "Real Estate Platform",
    categoryAr: "منصة عقارية",
    description: "Property listing and virtual tour platform",
    descriptionAr: "منصة قوائم العقارات والجولات الافتراضية",
    type: "website",
    client: "Qatar Real Estate Group",
    clientAr: "مجموعة قطر العقارية",
    challenge: "Create an immersive property browsing experience with virtual tours, advanced search filters, and direct agent communication.",
    challengeAr: "إنشاء تجربة تصفح عقاري غامرة مع جولات افتراضية ومرشحات بحث متقدمة والتواصل المباشر مع الوكلاء.",
    solution: "Built a feature-rich real estate platform with 360° virtual tours, map-based search, mortgage calculator, and integrated CRM for agents.",
    solutionAr: "أنشأنا منصة عقارية غنية بالميزات مع جولات افتراضية بزاوية 360 درجة وبحث قائم على الخريطة وحاسبة رهن عقاري ونظام CRM متكامل للوكلاء.",
    results: "5,000+ property listings, 100,000+ monthly visitors, 45% increase in lead conversions",
    resultsAr: "أكثر من 5000 قائمة عقارية، أكثر من 100000 زائر شهريًا، زيادة بنسبة 45٪ في تحويلات العملاء المحتملين",
    technologies: ["Next.js", "Three.js", "PostgreSQL", "Mapbox", "AWS CloudFront"],
    imageUrl: "/attached_assets/generated_images/Website_laptop_mockup_elegant_a69c9d74.png"
  },
  {
    title: "Education Learning App",
    titleAr: "تطبيق التعليم الإلكتروني",
    category: "Educational Platform",
    categoryAr: "منصة تعليمية",
    description: "Interactive learning platform for students",
    descriptionAr: "منصة تعليمية تفاعلية للطلاب",
    type: "mobile",
    client: "Qatar Education Institute",
    clientAr: "معهد قطر التعليمي",
    challenge: "Develop an engaging e-learning platform that supports Arabic curriculum, offline access, and progress tracking for students of all ages.",
    challengeAr: "تطوير منصة تعليم إلكتروني جذابة تدعم المنهج العربي والوصول دون اتصال بالإنترنت وتتبع التقدم للطلاب من جميع الأعمار.",
    solution: "Created an interactive learning app with video lessons, quizzes, gamification, offline mode, and parent/teacher dashboards for monitoring progress.",
    solutionAr: "أنشأنا تطبيق تعليمي تفاعلي مع دروس الفيديو والاختبارات والألعاب ووضع عدم الاتصال ولوحات معلومات الوالدين/المعلمين لمراقبة التقدم.",
    results: "3,000+ enrolled students, 85% course completion rate, 4.9/5 parent satisfaction rating",
    resultsAr: "أكثر من 3000 طالب مسجل، معدل إكمال الدورة 85٪، تقييم رضا الوالدين 4.9/5",
    technologies: ["React Native", "Node.js", "PostgreSQL", "Video.js", "Redux"],
    imageUrl: "/attached_assets/generated_images/Mobile_app_mockup_clean_d2c9db56.png"
  }
];
